...
public final class ItemAddDishBinding implements ViewBinding {
  ...
  private ItemAddDishBinding(@NonNull ConstraintLayout rootView, @NonNull Button addDish,
      @NonNull CardView cardView3, @NonNull LinearLayout dishLinear, @NonNull TextView introText,
      @NonNull TextInputLayout menuAddDishType, @NonNull NestedScrollView nestedScrollView,
      @NonNull Button removeType) {
