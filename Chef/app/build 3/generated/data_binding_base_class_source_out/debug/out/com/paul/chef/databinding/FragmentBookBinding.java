...
public final class FragmentBookBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView addressTextView;
  ...
  private FragmentBookBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageView addressTextView, @NonNull TextView bookAddress,
      @NonNull Chip bookChefSpaceChip, @NonNull ChipGroup bookChipGroup,
      @NonNull TextInputEditText bookDateSelect, @NonNull TextInputLayout bookDateSelectLayout,
      @NonNull Button bookEditAddress, @NonNull TextInputLayout bookNoteLayout,
      @NonNull TextInputEditText bookPeopleSelect, @NonNull TextInputLayout bookPeopleSelectLayout,
      @NonNull TextInputEditText bookTimeSelect, @NonNull TextInputLayout bookTimeSelectLayout,
      @NonNull Chip bookUserSpaceChip, @NonNull MaterialCardView cardView2, @NonNull View divider14,
      @NonNull View divider34, @NonNull TextView finalPerPrice, @NonNull TextView finalTotal,
  ...
  public static FragmentBookBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ImageView addressTextView = ViewBindings.findChildViewById(rootView, id);
